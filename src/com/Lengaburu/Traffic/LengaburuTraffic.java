...
public class LengaburuTraffic {
	...
	public static void main(String[] args) throws IOException {
		...
		while(!(cityVisitUserInput.matches("-?\\d+")&&(Integer.parseInt(cityVisitUserInput)==1 || Integer.parseInt(cityVisitUserInput)==2))) {
		...
		if(cityVisitDision==1 || cityVisitDision==2) {
			System.out.println("Please enter orbit1 traffic speed in format \"Orbit1 traffic speed is <TrafficSpeed> megamiles/hour\": ");
			...
			System.out.println("Please enter orbit2 traffic speed in format \"Orbit2 traffic speed is <TrafficSpeed> megamiles/hour\":");
		...
		if(cityVisitDision==2) {
			...
			System.out.println("Please enter orbit3 traffic speed in format \"Orbit3 traffic speed is <TrafficSpeed> megamiles/hour\": ");
			...
			System.out.println("Please enter orbit4 traffic speed in format \"Orbit4 traffic speed is <TrafficSpeed> megamiles/hour\":");
